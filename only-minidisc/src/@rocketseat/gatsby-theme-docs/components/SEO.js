// https://github.com/jpedroschmitz/rocketdocs/blob/main/@rocketseat/gatsby-theme-docs/src/components/SEO.js
...
export default function SEO({ description, title, slug, image, children }) {
  ...
  // https://stackoverflow.com/a/7572512/1872200
  const metaImage = `${urljoin(siteUrl, image || siteImage)}?v=1`;
